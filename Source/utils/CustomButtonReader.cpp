...
ax::Object *CustomButtonReader::createInstance() { return CustomButtonReader::getInstance(); }
ax::ObjectFactory::TInfo CustomButtonReader::__Type("ButtonReader", &CustomButtonReader::createInstance);
...
ax::Node* CustomButtonReader::createNodeWithFlatBuffers(const flatbuffers::Table* buttonOptions) {
